package jjun.jjunapp.programdrs.Communication.Protocol.STK500;
...
//        this.inputstream = inputstream;
    ...
    public boolean programHexFile(byte[] binaryFile, int numberOfBytes, boolean checkWrittenData, byte[] command_set) {
